...
import imgStavangerPulse from "../assets/imgStavangerPulse.png";
...
const projects = [
  ...
  {
    id: 8,
    name: "Stavanger Pulse 📊🌍",
    type: "Personal Project",
    image: imgStavangerPulse,
    technologies: [
      "React",
      "TypeScript",
      "Vite",
    ...
    liveDemo: "https://stavanger-pulse.netlify.app/",
    problem:
      "Build a modern data dashboard for Stavanger that visualizes real municipal and public registry data in a clean and responsive UI.",
    solution:
      "Developed a React + TypeScript dashboard that fetches and visualizes population, parking, tide, cultural, and registry data with a modular architecture.",
    whatIDid: [
      "Built reusable data visualization components",
      "Integrated multiple public APIs (municipal, Kartverket, etc.)",
      "Implemented filtering and data aggregation logic",
      "Created interactive maps using Leaflet",
      "Designed a responsive UI with Tailwind CSS",
      "Structured app with scalable folder architecture",
    ],
    feedback: null,
  },
